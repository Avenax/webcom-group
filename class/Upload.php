...
class Upload {
    ...
    function upload($file, $lang = 'ru_RU') {
        ...
        $this->lang = $lang;
        if ($this->lang != 'ru_RU' && file_exists(ROOT . '/config/lang') && file_exists(ROOT . '/config/lang/class.upload.' . $lang . '.php')) {
            $translation = null;
            include_once ROOT . '/config/lang/class.upload.ru_RU.php';
    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
                ...
                $this->file_dst_name_body = preg_replace(array('/\s/', '/\.[\.]+/', '/[^\w_\.\-]/'), array(
                    '_',
                    '.',
                    ''
                ), $this->file_dst_name_body);
